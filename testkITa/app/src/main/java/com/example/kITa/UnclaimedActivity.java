...
public class UnclaimedActivity extends AppCompatActivity {
    ...
    private static final String URL = "https://hookworm-advanced-shortly.ngrok-free.app/lost_found_db/get_items_details.php";
    ...
    private void displayItemDetails(JSONObject item) throws JSONException {
        ...
        if (!item.isNull("img3") && !item.getString("img3").isEmpty()) {
            slideModels.add(new SlideModel("https://hookworm-advanced-shortly.ngrok-free.app/lost_found_dbuploads/img_reported_items/" + item.getString("img3"), ScaleTypes.CENTER_INSIDE));
        }
